...
const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    subtitle: "COLLECTION",
    description:
      "L'excellence horlogère dans sa forme la plus pure, une fusion parfaite entre tradition et innovation.",
    buttonText: "EXPLORER LA COLLECTION",
  },
]
      ...
      <div className="absolute inset-0 z-30">
        <div className="max-w-[1920px] mx-auto px-8 h-full flex items-center">
          ...
          >
            ...
            <h1 className="font-extralight mb-6">
              <span className="text-7xl tracking-wide block mb-2 leading-tight">{currentHero.title}</span>
              <span className="text-7xl tracking-wide block leading-tight">{currentHero.subtitle}</span>
            </h1>
            <p className="text-xl font-light mb-12 text-gray-200">{currentHero.description}</p>
            <div className="flex gap-6">
              <button
                onClick={onDiscoverClick}
                className="bg-white text-black px-12 py-4 text-sm tracking-wider hover:bg-gray-100 transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg"
